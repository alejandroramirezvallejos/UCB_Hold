...
namespace IMT_Reservas.Tests.ControllerTests
{
    ...
    public class CategoriaControllerTest
    {
        ...
        public void GetCategorias_ConDatos_RetornaOk()
        {
            ...
            {
                new CategoriaDto { Id = 1, Nombre = "Periféricos" },
                new CategoriaDto { Id = 2, Nombre = "Componentes PC" }
            };
        ...
        {
            CrearCategoriaComando comando = new CrearCategoriaComando("Monitores"); 
            _categoriaServiceMock.Setup(s => s.CrearCategoria(comando)); // Asumiendo que CrearCategoria es void y el controller devuelve Created()
        ...
        {
            ActualizarCategoriaComando comando = new ActualizarCategoriaComando(1, "Monitores LED");
