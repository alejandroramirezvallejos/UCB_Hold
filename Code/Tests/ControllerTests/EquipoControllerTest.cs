...
namespace IMT_Reservas.Tests.ControllerTests
{
    ...
    public class EquipoControllerTest
    {
        ...
        public void GetEquipos_ConDatos_RetornaOk()
        {
            ...
            {
                new EquipoDto { Id = 1, NombreGrupoEquipo = "Laptop" },
                new EquipoDto { Id = 2, NombreGrupoEquipo = "Proyector" }
            };
        ...
        {
            CrearEquipoComando comando = new CrearEquipoComando("Laptop", "ThinkPad T480", "Lenovo", null, null, null, null, null, null, null, null);
        ...
        {
            ActualizarEquipoComando comando = new ActualizarEquipoComando(1, "Laptop Gaming", null, null, null, null, null, null, null, null, null);
