...
namespace IMT_Reservas.Tests.ControllerTests
{
    ...
    public class GaveteroControllerTest
    {
        ...
        public void GetGaveteros_ConDatos_RetornaOk()
        {
            ...
            {
                new GaveteroDto { Id = 1, Nombre = "Gavetero A1" },
                new GaveteroDto { Id = 2, Nombre = "Gavetero B2" }
            };
        ...
        {
            CrearGaveteroComando comando = new CrearGaveteroComando("Gavetero C3", "Estándar", "Armario 1", 50, 40, 20);
        ...
        {
            ActualizarGaveteroComando comando = new ActualizarGaveteroComando(1, "Gavetero Actualizado", "Nuevo Tipo", "Armario 2", 60, 50, 25);
