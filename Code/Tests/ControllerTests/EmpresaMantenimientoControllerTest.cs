...
{
    [TestFixture]
    public class EmpresaMantenimientoControllerTest
    {
        ...
        public void GetEmpresas_ConDatos_RetornaOk()
        {
            ...
            {
                new EmpresaMantenimientoDto { Id = 1, NombreEmpresa = "Tech Services" },
                new EmpresaMantenimientoDto { Id = 2, NombreEmpresa = "FixItAll" }
            };
        ...
        {
            CrearEmpresaMantenimientoComando comando = new CrearEmpresaMantenimientoComando("Nueva Empresa", "Juan", "Perez", "12345678", "Calle Falsa 123", "123456789");
        ...
        {
            ActualizarEmpresaMantenimientoComando comando = new ActualizarEmpresaMantenimientoComando(1, "Empresa Actualizada", "Ana", "Gomez", "87654321", "Av. Siempreviva 742", "987654321");
