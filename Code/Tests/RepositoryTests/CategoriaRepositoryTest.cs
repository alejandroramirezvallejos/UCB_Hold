...
namespace IMT_Reservas.Tests.RepositoryTests
{
    ...
    public class CategoriaRepositoryTest
    {
        ...
        public void Repositorio_CuandoHayExcepcion_LanzaExcepcion()
        {
            ...
            Assert.Throws<Exception>(() => _categoriaRepositorio.Crear(new CrearCategoriaComando("Test")));
            Assert.Throws<Exception>(() => _categoriaRepositorio.Actualizar(new ActualizarCategoriaComando(1, "Test")));
            Assert.Throws<Exception>(() => _categoriaRepositorio.Eliminar(1));
        }
    }
}
