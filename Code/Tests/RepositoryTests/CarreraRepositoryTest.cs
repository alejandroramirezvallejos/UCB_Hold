...
namespace IMT_Reservas.Tests.RepositoryTests
{
    ...
    public class CarreraRepositoryTest
    {
        ...
        public void Repositorio_CuandoHayExcepcion_LanzaExcepcion()
        {
            ...
            Assert.Throws<Exception>(() => _carreraRepositorio.Crear(new CrearCarreraComando("Test")));
            Assert.Throws<Exception>(() => _carreraRepositorio.Actualizar(new ActualizarCarreraComando(1, "Test")));
            Assert.Throws<Exception>(() => _carreraRepositorio.Eliminar(1));
        }
    }
}
