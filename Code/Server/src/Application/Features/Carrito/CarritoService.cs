...
public class CarritoService
{
    ...
    public CarritoService(ApplicationDbContext dbContext)
    {
    ...
    public async Task<Result<List<CarritoDto>>> ObtenerDisponibilidad(CarritoDto request)
    {
        ...
        if (request.FechaInicio == null || request.FechaFin == null || request.ArrayIds == null)
            return Result<List<CarritoDto>>.Error("Fecha inicio, fecha fin e IDs son requeridos");
