...
[Mapper]
public partial class EmpresaMantenimientoMapper : IMapper<EmpresaMantenimientoEntity, EmpresaMantenimientoDto>
{
    ...
    public partial IQueryable<EmpresaMantenimientoDto> ProjectTo(IQueryable<EmpresaMantenimientoEntity> source);
}
