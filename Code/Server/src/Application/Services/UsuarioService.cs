    ...
    public void CrearUsuario(CrearUsuarioComando comando)
    {
        ...
        catch (Exception ex)
        {
            if (ex is ErrorDataBase errorDb)
            {
                ...
                if (mensaje.Contains("no se encontró la carrera con nombre")) throw new ErrorReferenciaInvalida("carrera");
    ...
    public void ActualizarUsuario(ActualizarUsuarioComando comando)
    {
        ...
        catch (Exception ex)
        {
            if (ex is ErrorDataBase errorDb)
            {
                ...
                if (mensaje.Contains("carrera no encontrada o eliminada")) throw new ErrorReferenciaInvalida("carrera");
                if (mensaje.Contains("rol inválido") && mensaje.Contains("debe ser administrador o estudiante")) throw new ErrorCampoRequerido("rol");
