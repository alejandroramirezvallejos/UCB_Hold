...
/// <summary>
/// Generic EF Core repository base class. Replace old Repository class gradually.
/// TEntity: Database entity (Usuario, Equipo, etc)
/// TDto: DTO for API responses (UsuarioListDto, EquipoListDto, etc)
/// </summary>
public abstract class Repository<TEntity, TDto> where TEntity : class where TDto : class
{
    ...
    {
        // Override in derived class for entities with non-int PK or custom logic
