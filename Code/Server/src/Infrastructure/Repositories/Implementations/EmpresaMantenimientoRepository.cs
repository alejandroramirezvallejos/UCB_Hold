...
public class EmpresaMantenimientoRepository : Repository<EmpresaMantenimientoEntity, EmpresaMantenimientoList>
{
    ...
    protected override EmpresaMantenimientoList MapToDto(EmpresaMantenimientoEntity entity) => new()
    {
        Id = entity.Id,
