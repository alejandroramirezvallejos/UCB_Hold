...
PostgreSQL 14+ with Entity Framework Core 8. Schema DDL: [`DataBase/database.ddl`](../DataBase/database.ddl)
...
C# mapping: `[PgName]` attribute + `NpgsqlConnection.GlobalTypeMapper.MapEnum<T>()` in `Program.cs`.
